...
const HELP_STEPS = [
  ...
  "Tap the check to save, then Import. Import replaces the sellers belonging to that spreadsheet.",
  "Import is manual. Tap Import again when your Google Sheet changes.",
];
...
export { SourceRow, LegacySourceCard };
