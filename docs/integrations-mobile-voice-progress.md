...
- Apple TestFlight build detail now visibly shows 1.0.0 (25), assigned to the existing Team (Expo) internal group with one tester. Added and verified Saved test notes for file selection, mail approval, calendar reads, OAuth return/cancel and account switching, explicitly stating live voice is not enabled. No new tester/group/access was added and no public release was submitted.
