  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <button className="btn-google" onClick={handleGoogleAuth} disabled={loading}>
        ...
        <p className="auth-toggle">
          ...
          <button className="link-btn" onClick={() => { setIsSignUp(!isSignUp); setError(null); setMessage(null); }}>
