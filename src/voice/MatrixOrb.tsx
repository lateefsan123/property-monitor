...
// Adapted from Rare UI by Swami Malode: https://www.rareui.com/components/matrixorb
// Uses the app theme and plain CSS; no Tailwind/global style migration.
  ...
  return (
    ...
    >
      <canvas
        ref={canvasRef}
        aria-hidden
        className="matrix-orb-canvas"
        style={{ width: size, height: size, display: 'block' }}
      />
      <span role="status" aria-live="polite" hidden={labels?.[state] === ''}>
