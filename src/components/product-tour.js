export const TOUR_STEPS = [
  ...
  { title: "Keep an eye on your buildings", description: "Open Listings to browse buildings and their listings. Review price changes to spot a reason to follow up.", image: "product-market-story-colour-v2.png", page: "listing-alerts", target: ".app-crumb-page" },
