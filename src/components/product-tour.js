export const TOUR_STEPS = [
  ...
  { id: "schedule", title: "Your buildings, your schedule", description: "Choose buildings for each day and save a repeating week. Share sends evenly, with the option to fill unused slots from other buildings.", image: "product-schedule-v1.png", page: "schedule", target: ".app-crumb-page", cta: "Open schedule" },
