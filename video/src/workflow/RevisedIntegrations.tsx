...
import {IconTerminal2,IconSparkles,IconBrandOpenai,IconArrowRight,IconCheck} from '@tabler/icons-react';
...
export function RevisedIntegrations({words}:{words:Word[]}){
 ...
 const hosts=[['Codex',IconTerminal2],['Claude',IconSparkles],['ChatGPT',IconBrandOpenai]] as const;
