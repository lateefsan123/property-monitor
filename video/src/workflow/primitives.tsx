...
export const Cursor=({x,y,click=0}:{x:number;y:number;click?:number})=><div style={{...pos(x,y),transform:`scale(${1-.16*click})`,transformOrigin:'3px 3px',filter:'drop-shadow(0 2px 3px #0008)'}}><svg width="30" height="38" viewBox="0 0 30 38"><path d="M3 2L3 29L10 22L17 35L23 32L16 20L27 20Z" fill="#fff" stroke="#242423" strokeWidth="2"/></svg></div>;
